...
const Benefits = () => {
    return (
        <div className="h-full dark:bg-[#100724] dark:text-white" >
            <div className="px-20 py-10 max-sm:p-12">
                <div className="md:w-2/3 lg:w-1/2 pl-3 max-sm:pl-0">
                ...
                <div className="mt-10 grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl border border-gray-100 text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4">
                    <div className="group relative bg-white dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                        <div className="relative space-y-8 py-6 p-8">
                            <img
