...
const UserMenu = () => {
  ...
  return (
    <div className="animate__animated animate__fadeInUp animate__faster bg-slate-50 bg-opacity-80 max-w-[300px] w-full absolute right-5 mt-2 rounded-xl backdrop-blur-3xl backdrop-saturate-200 drop-shadow-2xl backdrop:shadow-2xl">
