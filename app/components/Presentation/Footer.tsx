...
import darkLogo from "../../../public/Logos/RoomFlyLogoWhiteTransparent.png";
import logo from "../../../public/Logos/RoomFlyLogo.png"

const Footer = () => {
    return (

        <footer className="bg-white dark:bg-[#100724] px-6 ">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 ">
                <div className="md:flex md:justify-between">
                    <div className="flex mb-6 md:mb-0">
                        <div className="flex">
                            <div className="flex img-toggle"/>
                            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white pl-2">Roomify</span>
                        </div>
